...
const (
	tblIncinerated = "CREATE TABLE IF NOT EXISTS `incinerated` ( `id` INT(11) NOT NULL AUTO_INCREMENT, `userID` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci', `timestamp` DATETIME NOT NULL DEFAULT current_timestamp(), `serverID` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci', PRIMARY KEY (`id`) USING BTREE, INDEX `FK_incinerated_users` (`userID`) USING BTREE, INDEX `FK_incinerated_servers` (`serverID`) USING BTREE, CONSTRAINT `FK_incinerated_servers` FOREIGN KEY (`serverID`) REFERENCES `servers` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT `FK_incinerated_users` FOREIGN KEY (`userID`) REFERENCES `users` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION ) COLLATE='utf8mb4_general_ci' ENGINE=InnoDB ;"
	tblRoles       = "CREATE TABLE IF NOT EXISTS `roles` ( `userID` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci', `serverID` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci', `roles` TEXT NOT NULL COLLATE 'utf8mb4_general_ci', `nickname` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci', PRIMARY KEY (`userID`, `serverID`) USING BTREE, INDEX `FK_roles_servers` (`serverID`) USING BTREE, INDEX `userID` (`userID`) USING BTREE, CONSTRAINT `FK_roles_servers` FOREIGN KEY (`serverID`) REFERENCES `servers` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT `FK_roles_users` FOREIGN KEY (`userID`) REFERENCES `users` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION ) COLLATE='utf8mb4_general_ci' ENGINE=InnoDB ;"
	tblServers     = "CREATE TABLE IF NOT EXISTS `servers` ( `id` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci', `name` VARCHAR(100) NOT NULL COLLATE 'utf8mb4_general_ci', PRIMARY KEY (`id`) USING BTREE ) COLLATE='utf8mb4_general_ci' ENGINE=InnoDB ;"
	tblUsers       = "CREATE TABLE IF NOT EXISTS `users` ( `id` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci', `name` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci', `isBot` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0', PRIMARY KEY (`id`) USING BTREE ) COLLATE='utf8mb4_general_ci' ENGINE=InnoDB ;"
)
