...
const (
	tblConfig     = "CREATE TABLE IF NOT EXISTS `config` ( `serverId` varchar(20) NOT NULL, `serverName` varchar(100) NOT NULL, `ruolo` varchar(20) NOT NULL, `testuale` varchar(20) NOT NULL, `vocale` varchar(20) NOT NULL, `invito` varchar(30) NOT NULL, `message` varchar(2000) NOT NULL, PRIMARY KEY (`serverId`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
